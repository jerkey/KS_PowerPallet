...
void SetPremixServoAngle(double percent) {
  ...
  // To address Bug #26 - may need to set PID output to this percent, and also call Reset to avoid any issues from rapid changes in output.
  // http://playground.arduino.cc/Code/PIDLibraryAdvancedMethods
  // Since this function is called during normal operation, this should only be applied during transitions, esp. Starting.
}
